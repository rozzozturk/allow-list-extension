...
const MESSAGES = {
  tr: {
    ...
    tooltipConnectionFilterCheckbox: 'Connection Filter Policy checkbox\'ını seçin',
    tooltipConnectionFilterPolicy: 'Connection filter policy\'ye tıklayın',
    tooltipEditConnectionFilter: 'Edit connection filter policy\'ye tıklayın',
    ...
    antispamStep2Description: 'Connection Filter Policy satırının checkbox\'ını seçin',
    antispamStep3Title: 'Connection Filter Policy',
    antispamStep3Description: 'Connection filter policy (Varsayılan) satırına tıklayın',
    antispamStep4Title: 'Edit Connection Filter',
    antispamStep4Description: 'Edit connection filter policy butonuna tıklayın',
    ...
    safelinksStep2Description: 'Email & Collaboration sekmesini açın',
    safelinksStep3Title: 'Policies & Rules',
    safelinksStep3Description: 'Policies and rules > Threat Policies kısmına gidin',
